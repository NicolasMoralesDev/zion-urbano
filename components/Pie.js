...
const Pie = () => {
  return (
    <footer className="container-fluid bg-dark text-light">
      ...
      <h6 id='copyright' > © Desarrollado por  <a href="https://www.linkedin.com/in/juannicolasmorales" className='nav-link'>  Nicolas Morales  </a>  y  <a href="https://www.linkedin.com/in/luciano-rivera-010a5b22b/" className='nav-link'>Luciano Rivera</a> - 2022</h6>
    </footer>
  )
}
